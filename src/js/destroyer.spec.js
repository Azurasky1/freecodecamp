...
describe('You will be provided with an initial array ' +
  ...
  it('destroyer(["tree", "hamburger", 53], "tree", 53) ' +
    ...
    expect(destroyer(['tree', 'hamburger', 53], 'tree', 53)).to.deep.equal(result);
  });
});
